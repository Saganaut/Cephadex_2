...
#     def preprocess(
#         self, terms: list[dict[str, Any]], card_type: str
#     ) -> list[dict[str, Any]]:
#         if card_type == "Mcq":
...
#         x, y, z = self.mapping.get("Formulas", ("A", "B", "C")) + (None,) * (
#             3 - len(self.mapping.get("Formulas", ("A", "B", "C")))
#         )  # noqa: E501
#         processed_terms = []
#         for item in terms:
#             term = item.get(x)
...
#         x, y, z = self.mapping.get("Discuss", ("A", "B", "C")) + (None,) * (
#             3 - len(self.mapping.get("Discuss", ("A", "B", "C")))
#         )  # noqa: E501
#         processed_terms = []
#         for item in terms:
#             term = item.get(x)
