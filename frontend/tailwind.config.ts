  ...
  theme: {
    extend: {
      ...
      typography: ({ theme }: PluginUtils) => ({
        DEFAULT: {
          css: {
            "--tw-prose-body": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-headings": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-lead": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-links": theme("colors.mariana-blue.DEFAULT"),
            "--tw-prose-bold": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-counters": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-bullets": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-hr": theme("colors.tolopea.DEFAULT"),
            "--tw-prose-quotes": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-quote-borders": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-captions": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-code": theme("colors.tolopea.DEFAULT"),
            "--tw-prose-th-borders": theme("colors.electric-violet.900"),
            "--tw-prose-td-borders": theme("colors.electric-violet.500"),
            "--tw-prose-em": theme("colors.tolopea.DEFAULT"),
            "--tw-prose-strong": theme("colors.tolopea.DEFAULT"),
            "--tw-prose-blockquote": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-figure": theme("colors.black-russian.DEFAULT"),
            "--tw-prose-figcaption": theme("colors.black-russian.DEFAULT"),
        ...
        dark: {
          css: {
            ...
            "--tw-prose-quote-borders": theme("colors.shell.DEFAULT"),
