...
########### error ##############
#### if route fails return error + error message

########## route ############
#### for redirects include a route object that includes type of redirect + optional id
...
##################  Deck Attributes ##########################
{
    "status": "success",
    "message": "",
    "deck-attributes": DeckAttributes,
}
