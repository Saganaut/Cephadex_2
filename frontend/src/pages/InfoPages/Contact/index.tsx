import { AddressInfo } from "@source/pages/InfoPages/Contact/AddressInfo";
import { FeedbackForm } from "@source/pages/InfoPages/Contact/FeedbackForm";
  ...
  return (
    <>
      <section className="relative text-gray-600">
        <div className="container mx-auto h-[70vh] flex flex-wrap sm:flex-nowrap">
