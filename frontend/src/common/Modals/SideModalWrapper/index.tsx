    ...
    <>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog
          ...
          className="  relative  right-[-800px] top-0 z-[99] transition-all duration-500 "
          onClick={(e) => {
            e.stopPropagation();
            setIsOpen(!isOpen);
          }}
        >
          ...
          <div className="fixed bottom-0 z-[250] h-screen w-screen sm:h-[70vh] sm:w-[50vw]">
            <div className="relative flex h-screen min-h-full w-full text-center sm:h-[70vh]">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-300"
              ...
              >
                ...
                >
                  <div
                    ...
                    className="absolute right-[20px] top-[20px] hidden h-[36px] w-[36px] cursor-pointer  items-center justify-center rounded-full bg-tolopea sm:flex"
                  >
