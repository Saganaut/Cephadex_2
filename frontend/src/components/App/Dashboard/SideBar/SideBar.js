...
import { SideBarLink } from 'components/App/Dashboard/SideBar/SideBarLink';
import { SideBarUpgradeLink } from 'components/App/Dashboard/SideBar/SideBarLink';
...
const SideBarApp = ({ isSidebarOpen, setSidebarOpen }) => {
  ...
  return (
  <>
<div className={`transform top-0 left-0 bg-mariana-blue fixed h-full ease-in-out transition-all duration-300 z-30
  ...
  lg:translate-x-0 lg:relative lg:z-0`}>
        ...
        <div className = "mt-20">
            <SideBarUpgradeLink isSidebarOpen={isSidebarOpen}/></div>
        </nav>
    </div>
