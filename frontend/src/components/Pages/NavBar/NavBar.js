...
import { StdButton } from "components/Common/Button";
  ...
  return (
    <header className="bg-white">
      ...
      >
        ...
        <StdButton onClick={() => { console.log('Button clicked!'); openSignInModal(); }} label="Log in" />
        </div>
      </nav>
      <Dialog
        as="div"
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
              <button  className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-black hover:bg-gray-50" onClick={openSignInModal}>Log in</button>
