...
<section className="text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <button className={`py-1 px-4 ${monthly ? 'bg-electric-violet text-white' : ''} focus:outline-none`} 
      onClick={toggleMonthly}> Monthly </button>
        <button 
        className={`py-1 px-4 ${!monthly ? 'bg-electric-violet  text-white' : ''} focus:outline-none`} 
