...
import createWorksheetIcon from 'components/Pages/LandingPage/LandingPageComponents/HowItWorksSection/assets/create-worksheet-icon.png';
import CustomDeckIcon from 'components/Pages/LandingPage/LandingPageComponents/HowItWorksSection/assets/custom-deck-icon.png';
import MasterIcon from 'components/Pages/LandingPage/LandingPageComponents/HowItWorksSection/assets/master-icon.png';
import SelectInputIcon from 'components/Pages/LandingPage/LandingPageComponents/HowItWorksSection/assets/select-input-icon.png';
...
const HowItWorksCard = ({ image, title, text, link }) => {
    return (
        <div>
            ...
            <Link className = "text-blaze-orange my-3" to={link}>Study time</Link>
        </div>
    );
}
        ...
        <div className="md:h-screen p-10">
            <div className="flex flex-col md:h-full">
                ...
                <div className="flex justify-center items-center mb-5">
                    <h1 className="text-4xl font-bold text-electric-violet">How it works</h1>
                </div>
