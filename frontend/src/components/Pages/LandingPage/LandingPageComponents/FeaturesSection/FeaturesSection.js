...
import { FeatureCard } from 'components/Pages/LandingPage/LandingPageComponents/FeaturesSection/FeatureCard.js';
...
const featuresContent = [
    {
        ...
        items: ["Turn your powerpoint presentations into quizzes",
    ...
    },
    {
        ...
        title: "Students",
        image: "https://dummyimage.com/305x305",
        items: ["Turn your notes, pdfs and ppts into quizzes to help you prepare for an upcoming exam",
            ...
            },
    {
        ...
        image: "https://dummyimage.com/305x305",
        items: ["Provide your viewers with tools to reinforce what they learn by watching your videos",
